    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final double carouselHeight = screenHeight - appBarHeight - footerHeight - additionalSpacing + 30.0;
      ...
      child: RotatedBox(
        ...
        child: Stack(
          children: [
            // Top border
            Positioned(
              top: 100, // Adjust this to control the distance from the first element
              left: 15,
              right: 15,
              child: Container(
            ...
            Padding(
              padding: EdgeInsets.only(left: 25.0, top: 30.0), // Adjust padding to avoid overlapping with the borders
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
